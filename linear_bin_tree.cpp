...
int main() {
	...
	LinearBinTree<string> tree = LinearBinTree<string>::InitLinearBinTree(capacity);
	...
	cout << "GetTreeNodeRank(&eigth_node): " << tree.GetTreeNodeRank(&eight_node) << endl;
	return 0;
}
